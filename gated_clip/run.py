...
train_dataset = VQA_mm_Dataset("../../../../net/projects/ranalab/kh310/vqa", "train")
qa_dataset_val = VQA_mm_Dataset("../../../../net/projects/ranalab/kh310/vqa", "val")
